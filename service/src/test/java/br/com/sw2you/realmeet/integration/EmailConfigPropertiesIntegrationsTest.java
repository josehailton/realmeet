...
public class EmailConfigPropertiesIntegrationsTest extends BaseIntegrationTest {
    @Autowired
    ...
    void testLoadConfigProperties() {
        ...
        assertEquals(starttlsEnable, emailConfigProperties.getProperty(PROPERTY_SMTP_STARTTLS_ENABLE));
    }
}
