...
class AllocationReportValidatorUnitTest extends BaseUnitTest {
    ...
    void testValidateWhenEmailIsMissing() {
        ...
        assertEquals(
            new ValidationError(ValidatorConstants.EMAIL, ValidatorConstants.EMAIL + MISSING),
    ...
    void testValidateWhenDateFromIsMissing() {
        ...
        assertEquals(1, exception.getValidationErrors().getNumberOfErrors());
        assertEquals(
            new ValidationError(ValidatorConstants.DATE_FROM, ValidatorConstants.DATE_FROM + MISSING),
            exception.getValidationErrors().getError(0)
        );
    }
    ...
    void testValidateWhenDateToIsMissing() {
        ...
        assertEquals(1, exception.getValidationErrors().getNumberOfErrors());
        assertEquals(
            new ValidationError(ValidatorConstants.DATE_TO, ValidatorConstants.DATE_TO + MISSING),
            exception.getValidationErrors().getError(0)
        );
    }
}
